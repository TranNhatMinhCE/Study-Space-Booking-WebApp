    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Sinh viên'), ('teacher', 'Giảng viên'), ('manager', 'Ban quản lý')], default='student', max_length=20)),
            ...
            options={
                'permissions': [('view_own_profile', 'Can view own profile'), ('edit_own_profile', 'Can edit own profile'), ('view_all_users', 'Can view all users'), ('generate_report', 'Can generate user report')],
            },
            managers=[
